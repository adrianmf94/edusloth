...
const DashboardPage = () => {
  ...
  const { contents, fetchContents, isLoading: contentsLoading } = useContentStore();
  const { upcomingReminders, fetchUpcomingReminders, completeReminder, isLoading: remindersLoading } = useReminderStore();
        ...
        <div className="bg-white shadow rounded-lg overflow-hidden">
          <div className="p-6">
            ...
            <p className="text-gray-600">
              Track your learning, manage your study materials, and create reminders all in one place.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white shadow rounded-lg overflow-hidden">
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              >
                <span className="text-indigo-600 font-medium">Record Audio</span>
              </button>
              <Link 
                href="/content/upload"
          ...
          <div className="bg-white shadow rounded-lg overflow-hidden">
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-medium text-gray-900">Record Audio</h3>
                <button 
        ...
        <div className="bg-white shadow rounded-lg overflow-hidden">
          <div className="p-6">
            ...
            {contentsLoading ? (
              ...
              <p className="text-gray-500">No content yet. Upload a document or record audio to get started.</p>
            ) : (
