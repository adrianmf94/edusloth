...
class S3Service:
    ...
    async def upload_file(self, file: UploadFile, user_id: str, file_type: str = None):
        """
    ...
    def generate_presigned_url(self, s3_path, bucket_name=None, expiration=3600):
        """
